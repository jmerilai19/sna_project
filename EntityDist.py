...
plt.ylim([-0.1, 16])
plt.xlim([0, 17])
plt.title("Distribution of the named entities in terms of number of tweets citing the entity")
plt.ylabel("Number of named entities (log)")
